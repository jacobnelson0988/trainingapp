...
const RUNNING_THEME = {
  key: "running",
  accent: "#e87a1c",
  filledBackground: "linear-gradient(135deg, #e87a1c 0%, #b9520f 100%)",
  filledBorder: "#e87a1c",
  filledText: "#fff7f2",
  filledMeta: "rgba(255, 247, 242, 0.76)",
  filledShadow: "0 16px 32px rgba(232, 122, 28, 0.18)",
  softBackground: "linear-gradient(180deg, rgba(255,248,240,0.98) 0%, rgba(255,241,226,0.94) 100%)",
  softBorder: "rgba(232, 122, 28, 0.24)",
  softText: "#111827",
  softMeta: "#a64f12",
  softShadow: "0 12px 24px rgba(232, 122, 28, 0.10)",
...
const PREHAB_THEME = {
  key: "prehab",
  accent: "#2d7a6b",
  filledBackground: "linear-gradient(135deg, #2d7a6b 0%, #1f5c51 100%)",
  filledBorder: "#2d7a6b",
  filledText: "#f4fffc",
  filledMeta: "rgba(244, 255, 252, 0.74)",
  filledShadow: "0 14px 28px rgba(45, 122, 107, 0.16)",
  softBackground: "linear-gradient(180deg, rgba(250,255,253,0.99) 0%, rgba(238,250,247,0.95) 100%)",
  softBorder: "rgba(45, 122, 107, 0.24)",
  softText: "#1a1814",
  softMeta: "#2d7a6b",
  softShadow: "0 10px 24px rgba(45, 122, 107, 0.08)",
  badgeBackground: "rgba(45, 122, 107, 0.10)",
  badgeColor: "#2d7a6b",
  dotColor: "#2d7a6b",
}
